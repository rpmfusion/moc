...
Version: 2.6
Release: 0.60.svn%{checkout}%{?dist}
License: GPLv3+
...
export CFLAGS="-O0 -g"
%endif
export LDFLAGS="%{__global_ldflags} -Wl,-rpath,%{_libdir}/mocp/decoder_plugins"
%configure \
...
%else
 --disable-debug \
%endif
 LT_SYS_LIBRARY_PATH=%{_libdir}/mocp/decoder_plugins \
...
%changelog
* Sun Aug 02 2026 RPM Fusion Release Engineering <leigh123linux@rpmfusion.org> - 2.6-0.60.svn3005
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Feb 02 2026 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-0.59.svn3005
...
* Sun Jul 27 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-0.56.svn3005
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri May 30 2025 Leigh Scott <leigh123linux@gmail.com> - 2.6-0.55.svn3005
- Rebuild for new flac .so version

* Tue Jan 28 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-0.54.svn3005
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Tue Nov 12 2024 Mamoru TASAKA <mtasaka@fedoraproject.org> - 2.6-0.53.svn3005
- Patch for ffmpeg7, basically from debian with a bit modified

* Wed Nov 06 2024 Sérgio Basto <sergio@serjux.com> - 2.6-0.52.svn3005
- Rebuild for ffmpeg-7

* Fri Aug 02 2024 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-0.51.svn3005
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Sat Feb 03 2024 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-0.50.svn3005
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Wed Nov 08 2023 Leigh Scott <leigh123linux@gmail.com> - 2.6-0.49.svn3005
- Rebuild for new faad2 version

* Wed Aug 02 2023 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-0.48.svn3005
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Mon Mar 06 2023 Leigh Scott <leigh123linux@gmail.com> - 2.6-0.47.svn3005
